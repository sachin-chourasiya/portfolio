          ...
          <div className="col-lg-8">
            <div className="hero-content">
              ...
              <p className="hero-description">
                Experienced Backend Developer with proven expertise in
                developing and deploying secure, scalable web applications.
                Specialized in Node.js, Next.js, MongoDB, and AWS with a track
                record of reducing transaction times by 20% and improving system
                efficiencies.
              </p>
